...
private:
  ...
  /// "R.next = R + #bump".
  bool findInductionRegister(MachineLoop *L, Register &Reg, int64_t &IVBump,
...
bool HexagonHardwareLoops::findInductionRegister(MachineLoop *L, Register &Reg,
                                                 int64_t &IVBump,
                                                 MachineInstr *&IVOp) const {
