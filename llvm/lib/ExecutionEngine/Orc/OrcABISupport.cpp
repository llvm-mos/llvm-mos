...
void OrcX86_64_SysV::writeResolverCode(char *ResolverWorkingMem,
  ...
  const uint8_t ResolverCode[] = {
      ...
      0x02,
      0x00,
      0x00, // 0x1a: subq      0x208, %rsp
      0x48,
      0x0f,
      0xae,
      0x04,
      0x24, // 0x21: fxsave64  (%rsp)
      0x48,
      0xbf, // 0x26: movabsq   <CBMgr>, %rdi
      ...
      0x8b,
      0x75,
      0x08, // 0x30: movq      8(%rbp), %rsi
      0x48,
      0x83,
      0xee,
      0x06, // 0x34: subq      $6, %rsi
      0x48,
      0xb8, // 0x38: movabsq   <REntry>, %rax
      ...
      0x89,
      0x45,
      0x08, // 0x44: movq      %rax, 8(%rbp)
      0x48,
      0x0f,
      0xae,
      0x0c,
      0x24, // 0x48: fxrstor64 (%rsp)
      0x48,
      0x81,
      0xc4,
      0x08,
...
void OrcX86_64_Win32::writeResolverCode(char *ResolverWorkingMem,
  ...
  const uint8_t ResolverCode[] = {
      ...
      0x8B,
      0x55,
      0x08, // 0x30: mov       rdx, [rbp+0x8]
      0x48,
      0x83,
      0xea,
      0x06, // 0x34: sub       rdx, 0x6
      ...
      0x89,
      0x45,
      0x08, // 0x4C: movq      %rax, 8(%rbp)
      0x48,
      0x0f,
      0xae,
      0x0c,
      0x24, // 0x50: fxrstor64 (%rsp)
      0x48,
      0x81,
      0xc4,
      0x08,
