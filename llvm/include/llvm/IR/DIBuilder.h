...
class DIBuilder {
  ...
  void insertDbgVariableRecord(DbgVariableRecord *DVR, InsertPosition InsertPt);
...
public:
  ...
  createCompileUnit(DISourceLanguageName Lang, DIFile *File, StringRef Producer,
  ...
  /// \param Annotations Annotations. (optional)
  LLVM_ABI DIDerivedType *
  createTemplateAlias(DIType *Ty, StringRef Name, DIFile *File, unsigned LineNo,
                      DIScope *Context, DINodeArray TParams,
                      uint32_t AlignInBits = 0,
                      DINode::DIFlags Flags = DINode::FlagZero,
                      DINodeArray Annotations = nullptr);
  ...
  createMemberType(DIScope *Scope, StringRef Name, DIFile *File,
                   unsigned LineNo, Metadata *SizeInBits, uint32_t AlignInBits,
                   Metadata *OffsetInBits, DINode::DIFlags Flags, DIType *Ty,
                   DINodeArray Annotations = nullptr);
  ...
  /// \param Annotations         Member annotations.
  LLVM_ABI DIDerivedType *
  createBitFieldMemberType(DIScope *Scope, StringRef Name, DIFile *File,
                           unsigned LineNo, Metadata *SizeInBits,
                           Metadata *OffsetInBits, uint64_t StorageOffsetInBits,
  ...
  /// \param AlignInBits  Member alignment.
  LLVM_ABI DIDerivedType *
  createStaticMemberType(DIScope *Scope, StringRef Name, DIFile *File,
                         unsigned LineNo, DIType *Ty, DINode::DIFlags Flags,
                         Constant *Val, unsigned Tag, uint32_t AlignInBits = 0);
  ...
  createSubrangeType(StringRef Name, DIFile *File, unsigned LineNo,
                     ...
                     DINode::DIFlags Flags, DIType *Ty, Metadata *LowerBound,
  ...
  LLVM_ABI DISubprogram *createFunction(
      ...
      StringRef TargetFuncName = "", bool UseKeyInstructions = false);
