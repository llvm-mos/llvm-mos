...
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp ne i32 [[IV_1]], [[SMAX]]
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[GUARDED_1]], label [[FAIL_LOOPEXIT:%.*]]
; CHECK:       guarded.1:
...
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp ne i32 [[IV_2]], [[SMAX]]
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[GUARDED_2]], label [[FAIL_LOOPEXIT1:%.*]]
; CHECK:       guarded.2:
