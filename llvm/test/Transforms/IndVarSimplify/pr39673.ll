...
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp ne i16 [[L1_ADD]], 2
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[LOOP1]], label [[LOOP2_PREHEADER:%.*]]
...
; CHECK-NEXT:    [[EXITCOND1:%.*]] = icmp ne i16 [[K2_ADD]], 184
; CHECK-NEXT:    br i1 [[EXITCOND1]], label [[LOOP2]], label [[LOOP2_END:%.*]]
; CHECK:       loop2.end:
...
; CHECK-NEXT:    tail call void @foo(i16 [[K2]])
; CHECK-NEXT:    [[K2_ADD]] = add nuw nsw i16 [[K2]], 1
; CHECK-NEXT:    [[EXITCOND1:%.*]] = icmp ne i16 [[L2_ADD]], 2
; CHECK-NEXT:    br i1 [[EXITCOND1]], label [[LOOP2]], label [[LOOP2_END:%.*]]
; CHECK:       loop2.end:
...
; CHECK-NEXT:    tail call void @foo(i16 [[K2]])
; CHECK-NEXT:    [[K2_ADD]] = add nuw nsw i16 [[K2]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp ne i16 [[L2_ADD]], 2
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[LOOP2]], label [[LOOP2_END:%.*]]
; CHECK:       loop2.end:
; CHECK-NEXT:    [[K2_ADD_LCSSA:%.*]] = phi i16 [ [[K2_ADD]], [[LOOP2]] ]
; CHECK-NEXT:    ret i16 [[K2_ADD_LCSSA]]
;
