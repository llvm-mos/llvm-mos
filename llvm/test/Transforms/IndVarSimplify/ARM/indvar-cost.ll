...
; CHECK-T1-NEXT:    [[TMP5:%.*]] = load i16, i16* [[ARRAYIDX_I907]], align 2
; CHECK-T1-NEXT:    [[TMP6:%.*]] = load i16, i16* [[PX_31055]], align 2
...
; CHECK-T1-NEXT:    [[TMP7:%.*]] = load i16, i16* [[ARRAYIDX_I901]], align 2
; CHECK-T1-NEXT:    [[TMP8:%.*]] = load i16, i16* [[PY_31056]], align 2
...
; CHECK-T1-NEXT:    [[TMP9:%.*]] = load i16, i16* [[ARRAYIDX_I885]], align 2
; CHECK-T1-NEXT:    [[TMP10:%.*]] = load i16, i16* [[ADD_PTR_I912]], align 2
...
; CHECK-T1-NEXT:    [[TMP11:%.*]] = load i16, i16* [[ARRAYIDX_I879]], align 2
; CHECK-T1-NEXT:    [[TMP12:%.*]] = load i16, i16* [[ADD_PTR_I906]], align 2
...
; CHECK-T2-NEXT:    [[TMP5:%.*]] = load i16, i16* [[ARRAYIDX_I907]], align 2
; CHECK-T2-NEXT:    [[TMP6:%.*]] = load i16, i16* [[PX_31055]], align 2
...
; CHECK-T2-NEXT:    [[TMP7:%.*]] = load i16, i16* [[ARRAYIDX_I901]], align 2
; CHECK-T2-NEXT:    [[TMP8:%.*]] = load i16, i16* [[PY_31056]], align 2
...
; CHECK-T2-NEXT:    [[TMP9:%.*]] = load i16, i16* [[ARRAYIDX_I885]], align 2
; CHECK-T2-NEXT:    [[TMP10:%.*]] = load i16, i16* [[ADD_PTR_I912]], align 2
...
; CHECK-T2-NEXT:    [[TMP11:%.*]] = load i16, i16* [[ARRAYIDX_I879]], align 2
; CHECK-T2-NEXT:    [[TMP12:%.*]] = load i16, i16* [[ADD_PTR_I906]], align 2
