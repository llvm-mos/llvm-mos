; RUN: llvm-mc -triple mos -mcpu=moshuc6280 --filetype=obj -I %S/Inputs -o=%t.obj %s
; RUN: llvm-objdump --all-headers --print-imm-hex -D %t.obj | FileCheck %s

; A zero page immediate value to be used as an address
adrAddr8 = 0x20ea
...
_start:
  ...
  lda adrAddr8            ; CHECK: a5 ea
  lda adrImm8             ; CHECK: ad ea 00
