...
; ARM-NEXT:    and r1, r1, #255
; ARM-NEXT:    sub r1, r1, #1
...
; THUMB1-NEXT:    adds r1, r0, #1
; THUMB1-NEXT:    uxtb r1, r1
; THUMB1-NEXT:    subs r1, r1, #1
...
; THUMB2-NEXT:    adds r1, r0, #1
; THUMB2-NEXT:    mov.w r2, #-1
; THUMB2-NEXT:    uxtab r1, r2, r1
...
; V8MBASE-NEXT:    adds r1, r0, #1
; V8MBASE-NEXT:    uxtb r1, r1
