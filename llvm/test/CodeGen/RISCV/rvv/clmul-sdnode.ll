...
; RV32V-NEXT:    sw t5, 4(sp) # 4-byte Folded Spill
; RV32V-NEXT:    csrr a0, vlenb
...
; RV32V-NEXT:    mv s2, t5
; RV32V-NEXT:    slli t5, t5, 2
; RV32V-NEXT:    add t5, t5, s2
; RV32V-NEXT:    add t5, sp, t5
; RV32V-NEXT:    addi t5, t5, 288
; RV32V-NEXT:    vl2r.v v22, (t5) # vscale x 16-byte Folded Reload
...
; RV32V-NEXT:    mv s1, t5
; RV32V-NEXT:    slli t5, t5, 1
; RV32V-NEXT:    add s1, s1, t5
; RV32V-NEXT:    slli t5, t5, 1
; RV32V-NEXT:    add s1, s1, t5
; RV32V-NEXT:    slli t5, t5, 1
; RV32V-NEXT:    add t5, t5, s1
; RV32V-NEXT:    add t5, sp, t5
; RV32V-NEXT:    addi t5, t5, 288
...
; RV32V-NEXT:    mv t5, s6
; RV32V-NEXT:    slli s6, s6, 1
; RV32V-NEXT:    add t5, t5, s6
; RV32V-NEXT:    slli s6, s6, 3
; RV32V-NEXT:    add s6, s6, t5
; RV32V-NEXT:    lw t5, 4(sp) # 4-byte Folded Reload
; RV32V-NEXT:    add s6, sp, s6
; RV32V-NEXT:    addi s6, s6, 288
...
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v24, v24, v0
; RV32V-NEXT:    sw s5, 4(sp) # 4-byte Folded Spill
; RV32V-NEXT:    csrr a1, vlenb
; RV32V-NEXT:    slli a1, a1, 3
; RV32V-NEXT:    mv a2, a1
; RV32V-NEXT:    slli a1, a1, 5
...
; RV32V-NEXT:    lw s5, 4(sp) # 4-byte Folded Reload
; RV32V-NEXT:    add s8, sp, s8
; RV32V-NEXT:    addi s8, s8, 288
...
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v24, v24, v0
; RV32V-NEXT:    sw s9, 4(sp) # 4-byte Folded Spill
; RV32V-NEXT:    csrr a0, vlenb
; RV32V-NEXT:    slli a0, a0, 3
; RV32V-NEXT:    mv a2, a0
; RV32V-NEXT:    slli a0, a0, 5
...
; RV32V-NEXT:    slli s9, s9, 4
; RV32V-NEXT:    mv s10, s9
; RV32V-NEXT:    slli s9, s9, 1
; RV32V-NEXT:    add s10, s10, s9
; RV32V-NEXT:    slli s9, s9, 1
; RV32V-NEXT:    add s10, s10, s9
; RV32V-NEXT:    slli s9, s9, 1
; RV32V-NEXT:    add s9, s9, s10
; RV32V-NEXT:    add s9, sp, s9
; RV32V-NEXT:    addi s9, s9, 288
; RV32V-NEXT:    vs8r.v v24, (s9) # vscale x 64-byte Folded Spill
; RV32V-NEXT:    addi s10, sp, 256
; RV32V-NEXT:    vlse64.v v0, (s10), zero
; RV32V-NEXT:    addi s10, sp, 248
; RV32V-NEXT:    vlse64.v v24, (s10), zero
; RV32V-NEXT:    csrr s9, vlenb
; RV32V-NEXT:    slli s9, s9, 3
; RV32V-NEXT:    mv s10, s9
; RV32V-NEXT:    slli s9, s9, 1
; RV32V-NEXT:    add s10, s10, s9
; RV32V-NEXT:    slli s9, s9, 1
...
; RV32V-NEXT:    vlse64.v v24, (s8), zero
; RV32V-NEXT:    csrr s8, vlenb
; RV32V-NEXT:    slli s8, s8, 3
; RV32V-NEXT:    mv s9, s8
; RV32V-NEXT:    slli s8, s8, 1
; RV32V-NEXT:    add s9, s9, s8
; RV32V-NEXT:    slli s8, s8, 2
; RV32V-NEXT:    add s9, s9, s8
; RV32V-NEXT:    slli s8, s8, 1
; RV32V-NEXT:    add s8, s8, s9
; RV32V-NEXT:    add s8, sp, s8
; RV32V-NEXT:    addi s8, s8, 288
; RV32V-NEXT:    vs8r.v v24, (s8) # vscale x 64-byte Folded Spill
; RV32V-NEXT:    csrr s8, vlenb
...
; RV32V-NEXT:    add s8, sp, s8
; RV32V-NEXT:    addi s8, s8, 288
; RV32V-NEXT:    vl8r.v v24, (s8) # vscale x 64-byte Folded Reload
; RV32V-NEXT:    vand.vv v24, v16, v24
; RV32V-NEXT:    csrr s8, vlenb
; RV32V-NEXT:    slli s8, s8, 5
; RV32V-NEXT:    mv s9, s8
; RV32V-NEXT:    slli s8, s8, 1
; RV32V-NEXT:    add s9, s9, s8
; RV32V-NEXT:    slli s8, s8, 1
...
; RV32V-NEXT:    mv s9, s10
; RV32V-NEXT:    slli s10, s10, 2
; RV32V-NEXT:    add s9, s9, s10
; RV32V-NEXT:    slli s10, s10, 1
; RV32V-NEXT:    add s10, s10, s9
; RV32V-NEXT:    lw s9, 4(sp) # 4-byte Folded Reload
