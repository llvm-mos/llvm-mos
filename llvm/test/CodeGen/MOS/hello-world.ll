; RUN: llc -O2 -verify-machineinstrs -o %t.6502 %s
; RUN: diff --strip-trailing-cr -u %S/Inputs/hello-world-expected.s %t.6502
; RUN: llc -mcpu=mos65c02 -O2 -verify-machineinstrs -o %t.65c02 %s
; RUN: diff --strip-trailing-cr -u %S/Inputs/hello-world-65c02-expected.s %t.65c02
