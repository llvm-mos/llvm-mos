...
; X86-BMI-NEXT:    mulxl %eax, %eax, %edi
; X86-BMI-NEXT:    addl %esi, %eax
; X86-BMI-NEXT:    adcl $0, %edi
; X86-BMI-NEXT:    movl %ecx, %edx
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-BMI-NEXT:    mulxl %ecx, %esi, %ebp
; X86-BMI-NEXT:    addl %eax, %esi
; X86-BMI-NEXT:    adcl %edi, %ebp
