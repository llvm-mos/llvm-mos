...
; X86-NOBMI-NEXT:    addl (%esp), %edi # 4-byte Folded Reload
...
; X86-NOBMI-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edi # 4-byte Reload
; X86-NOBMI-NEXT:    movl {{[0-9]+}}(%esp), %esi
; X86-NOBMI-NEXT:    movl %edi, (%esi,%ecx,8)
; X86-NOBMI-NEXT:    movl {{[0-9]+}}(%esp), %edi
; X86-NOBMI-NEXT:    movl (%esp), %esi # 4-byte Reload
; X86-NOBMI-NEXT:    movl %esi, 4(%edi,%ecx,8)
...
; X86-BMI-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-BMI-NEXT:    addl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Folded Spill
