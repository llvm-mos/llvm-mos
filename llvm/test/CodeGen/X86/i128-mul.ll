...
; X86-NOBMI-NEXT:    movl (%eax,%ebx), %ebx
; X86-NOBMI-NEXT:    movl 4(%eax,%edx), %ebp
...
; X86-NOBMI-NEXT:    adcl (%esp), %edi # 4-byte Folded Reload
...
; X86-BMI-NEXT:    movl %edi, (%ebx,%ecx)
; X86-BMI-NEXT:    adcl $0, %ebp
; X86-BMI-NEXT:    adcl $0, %eax
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %edi
; X86-BMI-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ebx # 4-byte Reload
; X86-BMI-NEXT:    movl (%esp), %ecx # 4-byte Reload
; X86-BMI-NEXT:    movl %ecx, 4(%edi,%ebx)
; X86-BMI-NEXT:    movl %ebx, %edi
; X86-BMI-NEXT:    addl $-1, %esi
; X86-BMI-NEXT:    adcl $-1, %edx
; X86-BMI-NEXT:    addl $8, %edi
