...
; CHECK-NEXT:  Loop %bb3: backedge-taken count is i4 4
; CHECK-NEXT:  Loop %bb3: constant max backedge-taken count is i4 4
; CHECK-NEXT:  Loop %bb3: symbolic max backedge-taken count is i4 4
