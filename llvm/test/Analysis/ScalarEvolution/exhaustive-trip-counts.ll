...
; CHECK-NEXT:  Loop %for.body: backedge-taken count is i4 5
; CHECK-NEXT:  Loop %for.body: constant max backedge-taken count is i4 5
; CHECK-NEXT:  Loop %for.body: symbolic max backedge-taken count is i4 5
