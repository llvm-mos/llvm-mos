...
// CHECK-LABEL: define dso_local void @test_struct_param(%struct.S* noalias nocapture writeonly sret(%struct.S) align 1 %agg.result, %struct.S* nocapture noundef readonly %s) {{.*}} {
